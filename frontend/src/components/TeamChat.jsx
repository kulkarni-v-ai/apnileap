...
const TeamChat = ({ allocationId, currentUser }) => {
  ...
  const fetchAllocationDetails = async () => {
    try {
      ...
      const res = await apiClient.get(`/allocations/${allocationId}`);
  ...
  const fetchMessages = async () => {
    try {
      const res = await apiClient.get(`/allocations/${allocationId}/chat`);
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      await apiClient.post(`/allocations/${allocationId}/chat`, {
